...
Section
	...
	File "${BIN}\Xceed.Wpf.AvalonDock.Themese.Aero.dll"
	File "${BIN}\Xceed.Wpf.AvalonDock.Themese.Metro.dll"
	File "${BIN}\Xceed.Wpf.AvalonDock.Themese.VS2010.dll"
...
Section "uninstall"
	...
	Delete "$INSTDIR\Xceed.Wpf.AvalonDock.Themese.Aero.dll"
	Delete "$INSTDIR\Xceed.Wpf.AvalonDock.Themese.Metro.dll"
	Delete "$INSTDIR\Xceed.Wpf.AvalonDock.Themese.VS2010.dll"
